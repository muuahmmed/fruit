...
import 'package:fruit/Login/cubit/Login_cubit.dart' show ShopLoginCubit;
...
import 'package:fruit/layout/layoutScreen.dart' show LayoutScreen;
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            BlocBuilder<ShopLoginCubit, ShopLoginStates>(
              bloc: cubit,
                  ...
                  children: [
                    ...
                    const Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Color(0xFF1E88E5), // Blue 800
                      ),
                    ),
                                  ...
                                  TextButton(
                                    onPressed: () {
                                      _showForgotPasswordDialog(
                                        context,
                                        BlocProvider.of<ShopLoginCubit>(
                                          context,
                                        ),
                                      );
                                    },
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        OutlinedButton(
                          onPressed: () {
                            // Access the cubit from the correct context
